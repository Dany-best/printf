...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	  ...
	  ft_toupper.c ft_strdup.c ft_calloc.c ft_substr.c ft_strjoin.c ft_strtrim.c \
	  ft_itoa.c ft_split.c ft_strmapi.c ft_putchar_fd.c ft_putstr_fd.c \
	  ft_putendl_fd.c ft_putnbr_fd.c

SRC_O = $(SRC:.c=.o)

SRC_O_BONUS = $(SRC_BONUS:.c=.o)
...
bonus:$(SRC_O_BONUS) $(SRC_O)
	ar rc $(NAME) $(SRC_O_BONUS) $(SRC_O)

clean:
	rm -f $(SRC_O) $(SRC_O_BONUS)
